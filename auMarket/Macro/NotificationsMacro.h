...
#define APP_CHANGED_LOCATION_AUTHORIZATION @"APP_CHANGED_LOCATION_AUTHORIZATION"

//账号更新通知
#define  ACCOUNT_UPDATE_NOTIFICATION    @"ACCOUNT_UPDATE_NOTIFICATION"
//配送相关状态需要更新的通知
#define  DELIVERY_STATE_UPDATE_NOTIFICATION    @"DELIVERY_STATE_UPDATE_NOTIFICATION"

//任务列表通知
#define  TASK_UPDATE_NOTIFICATION    @"TASK_UPDATE_NOTIFICATION"
#define  TASK_RELOAD_NOTIFICATION    @"TASK_RELOAD_NOTIFICATION"
